...
station_delete_dialog = ft.AlertDialog(
    title=ft.Text(f'Sender "{constants.current_station_index_to_delete["name"]}" löschen?'),
...
def search_stations():
    ...
    l = []
    for el in stations:
        img = ft.Container(ft.Icon(ft.icons.MUSIC_NOTE), width=50, height=50) if el["logo"] == "" else ft.Image(
